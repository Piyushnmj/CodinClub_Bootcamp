...
do
        ...
        mv $x c:/users/piyush/onedrive/desktop/Backup/Main/$javaFileName/$addFileName
done
...
do
        ...
        mv $x c:/users/piyush/onedrive/desktop/Backup/Main/$pyFileName/$subFileName
done
...
do
        ...
        mv $x c:/users/piyush/onedrive/desktop/Backup/Main/$jsFileName/$multiplyFileName
done
...
do
        ...
        mv $x c:/users/piyush/onedrive/desktop/Backup/Main/$htmlFileName/$divisionFileName
done
